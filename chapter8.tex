...
\begin{figure}[h]
	...
	\begin{tikzpicture}
		...
		\foreach \y in {28, ..., 52} {
			\draw[-, blue, thick]	(5.5, {\y/8}) to (10, {\y/8})
									(4, 5) to (5.5, {\y/8});
		}

		\foreach \y in {5, ..., 15} {
			\draw[-, blue, thick]	(7.5, {\y/5}) to (10, {\y/5})
									(6, 2) to (7.5, {\y/5});
		}
...
We can represent these band configurations in k-space, too, but these plots can get complicated. Luckily, there is a solution for that. (11)
