...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
        ...
        \draw[domain=-4:4, smooth, variable=\x, blue] plot ({\x}, {-0.7*cos(\x*100)+0.7}) node[right]{$E_2(k)$};
        \draw[domain=-4:4, smooth, variable=\x, blue] plot ({\x}, {-cos(\x*100)+3}) node[right]{$E_1(k)$};
		...
		\draw[->, green, very thick]	(-0.8, {-cos(-100)+3}) to (2.4, {-cos(-100)+3});
    \end{tikzpicture}
